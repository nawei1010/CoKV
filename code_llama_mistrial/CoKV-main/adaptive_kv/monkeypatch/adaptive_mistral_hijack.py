...
from adaptive_kv.monkeypatch.kv_utils import init_adaptive_snapkv, DynamicCacheSplitHeadFlatten
    ...
    **kwargs,
    ...
    if past_key_value is not None:
        ...
        if key_states.shape[-2] == kv_seq_len: # [SnapKV] add kv_cluster
            ...
            key_states_compress, value_states_compress = self.kv_cluster.update_kv(key_states, query_states, value_states, self.layer_idx)
