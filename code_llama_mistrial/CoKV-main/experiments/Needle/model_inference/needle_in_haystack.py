...
from adaptive_kv.monkeypatch.kv_utils import set_cokv_size,set_snapkv_size,set_headkv_size
...
if __name__ == "__main__":
    ...
    if args.mode == 'cokv':
        ht.change_given_adaptive_size(set_cokv_size(128,8,args.model, 'needle', args.cokv_alpha))
